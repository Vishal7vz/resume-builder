  ...
  return (
    <div className="min-h-screen bg-black text-slate-100 relative">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <div className="space-y-5">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight">
              <span className="bg-gradient-to-r from-emerald-400 via-cyan-400 to-indigo-400 bg-clip-text text-transparent">Modern AI Resume Builder</span>
            </h2>
            <p className="text-slate-300 leading-relaxed">
              Build ATS-friendly resumes with smart structuring and beautiful templates. Enhance content using AI, preview instantly, and export to PDF.
            </p>
            <ul className="text-slate-300 space-y-2">
              <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-emerald-400" /> ATS-optimized sections and keywords</li>
              <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-cyan-400" /> Multiple clean templates</li>
              <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-indigo-400" /> One-click PDF export and print</li>
            </ul>
          </div>
          <HeroThree />
        </div>
      ...
      <section className="container mx-auto px-4 pb-0">
        <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-6 shadow-lg shadow-black/30 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h3 className="text-xl font-semibold">Build with AI</h3>
            <p className="text-slate-300 mt-1 text-sm">Enter your details below and let AI generate a polished, ATS-friendly resume. Then download as PDF.</p>
          </div>
          <div className="flex items-center gap-3 w-full sm:w-auto">
            <button onClick={handleGenerate} disabled={loading} className="px-4 py-2 rounded-md bg-gradient-to-r from-emerald-600 to-cyan-600 text-white hover:from-emerald-500 hover:to-cyan-500 disabled:opacity-50 transition-all duration-200 hover:-translate-y-0.5 shadow-md shadow-emerald-900/30 w-full sm:w-auto">
              {loading ? 'Generating…' : 'Generate with AI'}
            </button>
            <button onClick={handleExportPdf} disabled={!generated} className="px-4 py-2 rounded-md border border-slate-700 bg-slate-900 hover:bg-slate-800 disabled:opacity-50 transition-all duration-200 hover:-translate-y-0.5 w-full sm:w-auto">
              Download PDF
            </button>
          </div>
        </div>
